...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'font-bold py-4 px-6 rounded-xl shadow-lg transition-all duration-200 focus:ring-2 focus:ring-offset-2 focus:outline-none active:scale-95';
